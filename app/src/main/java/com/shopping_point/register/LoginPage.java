package com.shopping_point.register;
...
import static com.shopping_point.register.RegisterPage.db;
...
String admin_email="admin@gmail.com",admin_password="admin";
    ...
    public void login_ac(View view) {
        ...
        cursor1 = db.rawQuery("SELECT * FROM student WHERE email='" + email + "' " , null);
            ...
            {
                Intent intent_adm = new Intent(getApplicationContext(),ProfilePage.class);
...
//                showMessage("success","Login successfully");
        ...
        if(flag==1)
        {
            Intent intent_wel = new Intent(getApplicationContext(),ProfilePage.class);
